...
class OrderProductAdapter(var context:Context) : RecyclerView.Adapter<OrderProductAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.binding.productQuantityText.text = productList[position].totalQuantity
        holder.binding.productUnitText.text = Utils.productUnit(context,productList[position].unitOfProduct)
